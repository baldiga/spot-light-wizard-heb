    ...
    return <div className="min-h-screen flex flex-col items-center justify-center bg-gray-50">
        ...
        <div className="w-64 mb-4">
          <div className="bg-gray-200 rounded-full h-3">
            <div className="bg-whiskey h-3 rounded-full transition-all duration-1000 ease-out" style={{
        ...
        {retryCount > 0 && <p className="text-sm text-gray-500 mt-4">
      ...
      <div className="max-w-4xl mx-auto">
        ...
        {error && <Alert variant="destructive" className="mb-6">
            ...
            <div className="flex gap-4 flex-wrap">
              <Button variant="outline" onClick={handleRetry} disabled={retryCount >= 2} className="flex items-center gap-2">
        ...
        {(chapters.length > 0 || !error) && <>
            ...
            {chapters.length > 0 && <div className="space-y-6 mb-8">
        ...
        <div className="flex justify-between">
          <Button variant="outline" onClick={handleBackToEdit} className="border-whiskey text-whiskey hover:bg-whiskey/10">
            חזרה לעריכה
          </Button>
          <Button onClick={handleConfirm} disabled={chapters.length === 0 && !outline} className="bg-whiskey hover:bg-whiskey-dark text-white disabled:opacity-50 disabled:cursor-not-allowed">
