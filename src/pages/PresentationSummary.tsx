      ...
      <div className="max-w-6xl mx-auto">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full" dir="rtl">
          ...
          <TabsContent value="main" className="space-y-6">
            <Card className="border-whiskey/20" dir="rtl">
              <CardHeader className="bg-whiskey/5 text-right">
                <CardTitle className="text-2xl text-gray-dark text-right">סיכום ההרצאה שלך</CardTitle>
              </CardHeader>
              <CardContent className="pt-6" dir="rtl">
                <div className="space-y-6 text-right">
                  <div>
                    <h3 className="text-xl font-bold text-gray-800 mb-4">נושא ההרצאה</h3>
                    <p className="text-gray-700 text-lg">{formData?.idea}</p>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="p-4 bg-blue-50 rounded-lg">
                        <h4 className="font-semibold text-blue-800 mb-2">משך זמן</h4>
                        <p className="text-gray-700">{formData?.duration} דקות</p>
                      </div>
                      <div className="p-4 bg-green-50 rounded-lg">
                        <h4 className="font-semibold text-green-800 mb-2">קהל יעד</h4>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
                    <Button onClick={() => setActiveTab("overview")} className="bg-blue-600 hover:bg-blue-700 text-white">
                      צפה בסקירה מלאה
                    </Button>
                    <Button onClick={() => setActiveTab("slides")} className="bg-green-600 hover:bg-green-700 text-white">
                      צפה במבנה השקפים
                    </Button>
                  </div>
                </div>
          ...
          <TabsContent value="overview" className="space-y-6">
            <Card className="border-whiskey/20" dir="rtl">
              <CardHeader className="bg-whiskey/5 text-right">
                <CardTitle className="text-2xl text-gray-dark text-right">סקירה מלאה של ההרצאה</CardTitle>
              </CardHeader>
              <CardContent className="pt-6" dir="rtl">
                <div className="space-y-6 text-right">
                  {outline && (
                    <>
                      <div>
                        <h3 className="text-xl font-bold text-gray-800 mb-4">מבנה ההרצאה</h3>
                        <p className="text-gray-700 whitespace-pre-line">{outline.presentationStructure}</p>
                      </div>

                      <div>
                        <h3 className="text-xl font-bold text-gray-800 mb-4">חלוקת זמן</h3>
                        <p className="text-gray-700 whitespace-pre-line">{outline.timeDistribution}</p>
                      </div>

                      <div>
                        <h3 className="text-xl font-bold text-gray-800 mb-4">מדריך מכירות</h3>
                        <p className="text-gray-700 whitespace-pre-line">{outline.salesGuide}</p>
                      </div>

                      <div>
                        <h3 className="text-xl font-bold text-gray-800 mb-4">תוכנית לאחר ההרצאה</h3>
                        <p className="text-gray-700 whitespace-pre-line">{outline.postPresentationPlan}</p>
                      </div>
                    </>
                  )}
                </div>
                        ...
                        <div key={chapter.id} className="border border-gray-200 rounded-lg p-4">
                          ...
                          <ul className="space-y-2">
                            {chapter.points.map((point) => (
                              <li key={point.id} className="text-gray-700 mr-4">
                                • {point.content}
                              </li>
                            ))}
                          </ul>
              ...
              <CardContent className="pt-6" dir="rtl">
                <div className="space-y-6 text-right">
                  {dynamicSlides && dynamicSlides.length > 0 ? (
                      ...
                      {dynamicSlides.map((slide, index) => (
                        <div key={index} className="border border-gray-200 rounded-lg p-4">
                          <div className="flex justify-between items-start mb-3">
                            <span className="text-sm text-gray-500">שקף {slide.number || index + 1}</span>
                            {slide.section && (
                          ...
                          <h4 className="text-lg font-bold text-gray-800 mb-2">{slide.headline}</h4>
                          <p className="text-gray-700 mb-3">{slide.content}</p>
                          
                          {slide.visual && (
                            <div className="mb-3">
                              <h5 className="font-semibold text-gray-700 mb-1">הצעה ויזואלית:</h5>
                          ...
                          {slide.notes && (
                            <div className="mb-3">
                              <h5 className="font-semibold text-gray-700 mb-1">הערות למרצה:</h5>
                          ...
                          {slide.timeAllocation && (
                            <div className="mb-3">
                              <h5 className="font-semibold text-gray-700 mb-1">הקצאת זמן:</h5>
                              <p className="text-gray-600 text-sm">{slide.timeAllocation}</p>
                            </div>
                          )}

                          {slide.engagementTip && (
                            <div className="mb-3">
                              <h5 className="font-semibold text-gray-700 mb-1">טיפ למעורבות:</h5>
                              <p className="text-gray-600 text-sm">{slide.engagementTip}</p>
                            </div>
                          )}
                        </div>
                      ))}
                    ...
                    <p className="text-gray-600">מבנה השקפים נטען...</p>
                  )}
                </div>
              </CardContent>
            </Card>
          ...
          <TabsContent value="sales-process" className="space-y-6">
            <Card className="border-whiskey/20" dir="rtl">
              <CardHeader className="bg-whiskey/5 text-right">
                <CardTitle className="text-2xl text-gray-dark text-right">אסטרטגיית מכירות</CardTitle>
              </CardHeader>
              <CardContent className="pt-6" dir="rtl">
                <div className="space-y-6 text-right">
                  {dynamicStrategy && (
                    <>
                          ...
                          <div className="space-y-3">
                            {dynamicStrategy.marketingChannels.map((channel: any, index: number) => (
                              <div key={index} className="p-4 bg-blue-50 rounded-lg">
                                <h4 className="font-semibold text-blue-800 mb-2">{channel.channel}</h4>
                                <p className="text-gray-700 mb-2">{channel.strategy}</p>
                                <div className="text-sm text-gray-600">
                                  <span className="font-medium">לוח זמנים:</span> {channel.timeline} | 
                                  <span className="font-medium"> תקציב:</span> {channel.budget}
                                </div>
                              </div>
                            ))}
                          </div>
                      ...
                      {dynamicStrategy.pricingStrategy && (
                        <div>
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div className="p-4 bg-green-50 rounded-lg">
                              <h4 className="font-semibold text-green-800 mb-2">כרטיס בסיסי</h4>
                              <p className="text-gray-700">{dynamicStrategy.pricingStrategy.basicTicket}</p>
                            </div>
                            <div className="p-4 bg-yellow-50 rounded-lg">
                              <h4 className="font-semibold text-yellow-800 mb-2">כרטיס VIP</h4>
                              <p className="text-gray-700">{dynamicStrategy.pricingStrategy.vipTicket}</p>
                            </div>
                            <div className="p-4 bg-purple-50 rounded-lg">
                              <h4 className="font-semibold text-purple-800 mb-2">כרטיס פרמיום</h4>
                              <p className="text-gray-700">{dynamicStrategy.pricingStrategy.premiumTicket}</p>
                            </div>
                            <div className="p-4 bg-blue-50 rounded-lg">
                              <h4 className="font-semibold text-blue-800 mb-2">חבילה ארגונית</h4>
                              <p className="text-gray-700">{dynamicStrategy.pricingStrategy.corporatePackage}</p>
                            </div>
                          </div>
                        </div>
                      )}
          ...
          <TabsContent value="opening-tools" className="space-y-6">
            <Card className="border-whiskey/20" dir="rtl">
              <CardHeader className="bg-whiskey/5 text-right">
                <CardTitle className="text-2xl text-gray-dark text-right">כלים לפתיחת ההרצאה</CardTitle>
              </CardHeader>
              <CardContent className="pt-6" dir="rtl">
                <div className="space-y-6 text-right">
                  {outline?.openingStyles && (
                    <div>
                      <h3 className="text-xl font-bold text-gray-800 mb-4">סגנונות פתיחה</h3>
                      <div className="space-y-3">
                        {outline.openingStyles.map((style: string, index: number) => (
                          <div key={index} className="p-4 bg-blue-50 rounded-lg">
                  ...
                  {outline?.discussionQuestions && Object.keys(outline.discussionQuestions).length > 0 && (
                    <div>
                      <h3 className="text-xl font-bold text-gray-800 mb-4">שאלות לדיון</h3>
                      <div className="space-y-4">
                        {Object.entries(outline.discussionQuestions).map(([topic, questions]: [string, any]) => (
          ...
          <TabsContent value="engagement" className="space-y-6">
            <Card className="border-whiskey/20" dir="rtl">
              <CardHeader className="bg-whiskey/5 text-right">
                <CardTitle className="text-2xl text-gray-dark text-right">כלים למעורבות קהל</CardTitle>
              </CardHeader>
              <CardContent className="pt-6" dir="rtl">
                <div className="space-y-6 text-right">
                  {outline?.interactiveActivities && (
                    <div>
                      <h3 className="text-xl font-bold text-gray-800 mb-4">פעילויות אינטראקטיביות</h3>
                      <div className="space-y-3">
                        {outline.interactiveActivities.map((activity: string, index: number) => (
                  ...
                  {engagementData && (
                    <div>
                      <h3 className="text-xl font-bold text-gray-800 mb-4">תוכן מעורבות מתקדם</h3>
                      <div className="p-4 bg-blue-50 rounded-lg">
                        <p className="text-gray-700 whitespace-pre-line">{JSON.stringify(engagementData, null, 2)}</p>
                      </div>
                    </div>
                  )}
                </div>
          ...
          {/* Marketing Tab - Keep existing content */}
